...
try {  
    ...
    # Brief description before installation  
    Write-Host @"
╔══════════════════════════════════════════╗
║           TSUNDERE DEV SETUP             ║
╚══════════════════════════════════════════╝
This script will set up your development environment with:
- Essential Git scripts (e.g., git-acp, git-pr, git-cleanup).
- Handy Git aliases (e.g., git st, git cm, git panic).
- A secure and optimized setup for your system.

It's designed to save you time and make your workflow smoother. 
Not like I care about your productivity or anything... BAKA!
